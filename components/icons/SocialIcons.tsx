...
// Brand glyphs — lucide-react has removed these to avoid trademark conflicts.
// Each icon is a `currentColor` SVG so it inherits the surrounding text color
// and accepts standard SVG props (className, width, height, etc.).
