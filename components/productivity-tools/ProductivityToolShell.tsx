...
import {
  ...
  getProductivityFeatureList,
  getProductivityHowTo,
  type HowToStep,
...
function getRelatedProductivityTools(currentId: string) {
...
function SeoSchemas({
  ...
  const featureList = getProductivityFeatureList(toolId);
  ...
  const breadcrumb = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Tools", item: `${base}/tools` },
      {
        ...
        item: `${base}/tools/categories/productivity-tools`,
      },
      {
        "@type": "ListItem",
        position: 4,
