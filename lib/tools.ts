...
export const TOOLS: Tool[] = [
  ...
  // ============================================================== Sleep Tools
  {
    ...
    description:
      "Free sleep cycle calculator that finds the best bedtime or wake-up time based on 90-minute sleep cycles.",
    longDescription:
      "Pick a wake-up time and see the optimal bedtimes that align with complete 90-minute sleep cycles — or pick a bedtime and see the best wake-up times. Includes a fall-asleep buffer and clear cycle counts so you wake between cycles, not in the middle of deep sleep.",
    ...
    cpc: 3,
    relatedTools: ["nap-calculator", "caffeine-cutoff-calculator", "brown-noise-generator"],
  },
  {
    id: "nap-calculator",
    name: "Nap Calculator",
    description:
      "Find the right nap length — power, recovery or full cycle — based on time available and your goal.",
    longDescription:
      "Pick how much time you have and what you need from the nap (alertness, recovery from lost sleep, or full restoration) and the calculator returns the recommended length and the time to set your alarm for — avoiding the 45–80 minute zone where most people wake mid-deep-sleep.",
    category: "Sleep Tools",
    icon: "Bed",
    ...
    new: true,
    featured: false,
    monthlySearches: 110_000,
    cpc: 2,
    relatedTools: ["sleep-cycle-calculator", "caffeine-cutoff-calculator"],
  },
  {
    id: "caffeine-cutoff-calculator",
    name: "Caffeine Cutoff Calculator",
    description:
      "When to stop drinking caffeine before bed, based on caffeine's 5-hour half-life and your bedtime.",
    longDescription:
      "Tell the calculator your bedtime, your usual drink and your caffeine sensitivity. It uses a 5-hour caffeine half-life (3.5 hr fast, 7 hr slow) to return the latest time you can have that coffee, tea or energy drink while keeping the caffeine left in your system below the sleep-disrupting threshold.",
    category: "Sleep Tools",
    icon: "Coffee",
    ...
    cpc: 3,
    relatedTools: ["sleep-cycle-calculator", "nap-calculator"],
  },
  {
    id: "brown-noise-generator",
    name: "Brown Noise Generator",
    description:
      "Free brown noise generated live in your browser — sleep, focus and tinnitus relief, with a sleep timer.",
    longDescription:
      "Brown noise on demand, generated sample-by-sample in your browser with the Web Audio API. Lower-frequency than white or pink noise, brown noise is the gentlest of the noise colours and a favourite for sleep, deep focus and tinnitus relief. Built-in sleep timer fades the audio out so it does not stop abruptly.",
    category: "Sleep Tools",
    icon: "Waves",
    href: "/tools/brown-noise-generator",
    externalHref: null,
    embedUrl: null,
    keywords: [
      "brown noise",
    ...
    monthlySearches: 1_400_000,
    cpc: 2,
    relatedTools: ["ambient-sound-mixer", "sleep-cycle-calculator"],
  },
  {
    id: "ambient-sound-mixer",
    name: "Ambient Sound Mixer",
    description:
      "Mix brown, pink, white noise plus rain and ocean ambience into your own sleep or focus soundscape.",
    longDescription:
      "Blend five procedurally-generated ambient tracks — brown, pink and white noise plus a rain-like bandpass texture and slow ocean swells — into your own custom mix. Independent volume sliders for each track, a master sleep timer, and zero downloads: everything synthesised live in the browser.",
    category: "Sleep Tools",
    icon: "Sliders",
    href: "/tools/ambient-sound-mixer",
    externalHref: null,
    embedUrl: null,
    keywords: [
      "ambient sound mixer",
    ...
    cpc: 2,
    relatedTools: ["brown-noise-generator", "sleep-cycle-calculator"],
  },
  ...
  },
  {
    ...
    name: "JPG ↔ PDF",
    description:
      "Convert JPGs (and PNGs) into a PDF, or render every page of a PDF as a high-quality JPEG.",
    longDescription:
      "Two converters in one tool. JPG → PDF: drop multiple images, reorder, pick A4 / Letter / Auto-fit, get one multi-page PDF. PDF → JPG: render every page to a 2×-resolution JPEG, single file or ZIP for multi-page PDFs. Both directions run in your browser.",
    category: "PDF Tools",
    icon: "FileImage",
    href: "/tools/jpg-pdf",
    externalHref: null,
